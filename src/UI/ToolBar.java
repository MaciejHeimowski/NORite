...
public class ToolBar extends UIPanel {
    ...
    public ToolBar() {
        ...
        JButton NANDButton = new JButton("NAND (A)");
        ...
        JButton NORButton = new JButton("NOR (N)");
        ...
        JButton WireButton = new JButton("Wire (W)");
        ...
        JButton BridgeButton = new JButton("Bridge (B)");
        ...
        JButton EraseButton = new JButton("Eraser (E)");
        ...
        SelectButton = new JButton("Select (S)");
        ...
        JButton DeleteButton = new JButton("Delete (D)");

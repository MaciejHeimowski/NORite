...
public class ToolBar extends UIPanel {
    public ToolBar() {
        ...
        NANDButton.setFont(new Font("Lucida Console", Font.PLAIN, 40));
        ...
        NORButton.setFont(new Font("Lucida Console", Font.PLAIN, 40));
        ...
        WireButton.setFont(new Font("Lucida Console", Font.PLAIN, 40));
        ...
        BridgeButton.setFont(new Font("Lucida Console", Font.PLAIN, 40));
        ...
        InputButton.setFont(new Font("Lucida Console", Font.PLAIN, 40));
        ...
        EraseButton.setFont(new Font("Lucida Console", Font.PLAIN, 40));
